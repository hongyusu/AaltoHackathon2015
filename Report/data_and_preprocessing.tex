...
We cannot maintain all individual track information $T_i$ and $V_i$ due to the following two reasons
\begin{itemize}
	\item It is computationally expensive to analyze $68,479$ tracks each time when we perform the recommendation or searching algorithm. In particular, the data file takes approximately $2$ Gigabyte.
	\item Individual track information is not an accurate representation of the track due to the nature of the \gps\ devices and the tracking algorithms. In other word, 
\end{itemize} 
