...
We select three cities for demo (London, New York, and Amsterdam) by using the \gps\ location data of the city centre and defined the city area as a block of $20km\times20km$.
We analyze all tracks within the predefined city block.
