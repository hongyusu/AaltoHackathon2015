...
\begin{itemize}
	\item The world map is partitioned into small blocks of $10m\times10m$. Each block $\vttt = (x,y)$ is represented by the \gps\ location of its centre, and is a potential vertex in the global track graph $\gtt$.
