...
We summerize and represent all track information via a global track graph $G=(V,E)$.
\begin{itemize}
	\item The world map is partitioned into small blocks of $10m\times10m$. Each block is represented by the \gps\ location of its centre, and is a potential vertex in the global track graph $G$.
\end{itemize}
